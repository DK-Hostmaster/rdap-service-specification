...
![Markdownlint Action](https://github.com/DK-Hostmaster/rdap-service-specification/workflows/Markdownlint%20Action/badge.svg)
![Spellcheck Action](https://github.com/DK-Hostmaster/rdap-service-specification/workflows/Spellcheck%20Action/badge.svg)
...
For issue reporting related to this specification, the RDAP implementation or the production environment, please contact us.  You are of course welcome to post these to the mailing list mentioned above, otherwise use the regular support channels.
